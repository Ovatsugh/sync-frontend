...
export default function ModalEdit({ onProduct, userproduct }) {
    ...
    async function handleSubmit(e) {
        e.preventDefault();
        try {
            const res = await api.put(`/products/edit/${product.id}`, product, {
                headers: {
            ...
            if (onProduct) {
                onProduct({ ...product, id: product.id });
            }

            Notification('success', 'Produto editado!');
            ...
            if(err.response.data.message) {
              ...
              Notification('error', 'Erro ao editar produto')
                    ...
                    <div className="modal-dialog">
                        <div className="modal-content">
                            <div className="modal-header">
                                <h1 className="modal-title fs-5" id="editModal">Editar Produto</h1>
